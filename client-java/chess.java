...
public class chess {
    ...
    private static Stack < String > board_stack = new Stack < String > (); //board stack for negamax unwinding
    private static HashMap < String, tableEntry > trans = new HashMap < String, tableEntry > (); //lazy transposition table
    ...
    public static String moveAlphabeta(int intDepth, int intDuration) {
        ...
        //if in tournament mode use some hard coded search depths
        if (intDepth < 0) {
            if (intDuration > 40000)
                intDepth = 9;
            else if (intDuration > 8000)
